...
class BProgram:
    ...
    def setup(self):
        ...
        self.advance_bthreads(None, None)

    def advance_bthreads(self, m, wm):
    ...
    def run(self):
        ...
        while not interrupted:
            ...
            if event is None:
                break
            if self.listener:
                interrupted, wm = self.listener.event_selected(b_program=self, event=event)
            self.advance_bthreads(event, wm)
